...
const dictionaries = {
  ru: {
    home: 'Главная', work: 'Моя работа', secretariat: 'Секретариат', incoming: 'Входящие', tasks: 'Задачи', processes: 'Процессы', organization: 'Организация', analytics: 'Аналитика',
  ...
  kk: {
    home: 'Басты бет', work: 'Менің жұмысым', secretariat: 'Хатшылық', incoming: 'Кіріс хаттар', tasks: 'Тапсырмалар', processes: 'Процестер', organization: 'Ұйым', analytics: 'Талдау',
  ...
  en: {
    home: 'Home', work: 'My work', secretariat: 'Secretariat', incoming: 'Incoming', tasks: 'Tasks', processes: 'Processes', organization: 'Organization', analytics: 'Analytics',
