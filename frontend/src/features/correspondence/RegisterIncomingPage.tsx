    ...
    <div className="form-layout">
      <div className="form-main">
        ...
        <Section title="Маршрутизация и контроль"><div className="field-grid">
          <label>Предварительное подразделение<select {...register('department')}><option value="">Определит руководитель</option><option>Стратегия и аналитика</option><option>Юридический департамент</option><option>Экономическое планирование</option><option>Инвестиционный департамент</option><option>Управление активами</option></select></label>
