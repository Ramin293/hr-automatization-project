...
export const addEmployeeDefaults: AddEmployeeFormValues = {
  ...
  department: '', team: '', position: '', manager: 'Не указан', employmentType: employmentTypes[0], workArrangement: workArrangements[0], workplace: 'Павлодар', startDate: '', probationMonths: 0, schedule: workSchedules[0], fte: 1, salary: '', currency: currencies[0], hiringReason: hiringReasons[1], responsibilities: 'Будут уточнены', justification: 'Не указано',
