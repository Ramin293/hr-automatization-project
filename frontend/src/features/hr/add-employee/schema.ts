...
export const addEmployeeSchema = z.object({
  ...
  maritalStatus: z.string(), emergencyContact: z.string(), emergencyPhone: optionalPhone, identityDocumentType: z.string(), identityDocumentNumber: z.string(), identityIssueDate: z.string(), identityExpirationDate: z.string(), issuingAuthority: z.string(),
  ...
  educationLevel: required('Выберите уровень образования'), institution: required('Укажите учебное заведение'), specialization: required('Укажите специальность'), graduationYear: z.string(), qualification: z.string(), totalExperience: z.string(), relevantExperience: z.string(), skills: z.string(), languages: z.string(), certifications: z.string(), additionalInfo: z.string(), requestText: required('Введите текст служебной записки')
